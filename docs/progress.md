...
**Phase 4 total (Items 15-18): 278 tests passing**
...
| 19 | PDC screen | ⬜ Pending | Stub file created. |
| 20 | Settings + Auto-Lap Config screen | ⬜ Pending | Stub files created (`settings_screen.dart`, `autolap_config_screen.dart`). |
